...
#ifndef PSDSERVICERREQUESTHANDLEREXT4_H
#define PSDSERVICERREQUESTHANDLEREXT4_H


#include "ParameterServiceRequestHandlerExt3.h"

//! Psd Service - Support dynamic reload partition
//! This interface is also for the remote client to make requests for Values, Handles or updates
//! 

namespace smf{
	class ParameterServiceRequestHandlerExt4 : public ParameterServiceRequestHandlerExt3
	{
	public:
		...
		//! \brief To dynamically reload a SMF partititon without restarting SMF.
		//! \param newPartitionPath	The path of the new partition .bin file. The values of the old partition will be imported to the new one.
        //! \param identifier		This is an identifier defined by the application. 
		//!							SMF does not use it; 
		//!							SMF will pass this back to you when reporting whether the request was accepted or not through your ParameterServiceResponseHandler implementation.
		//! \remark 				Include: ParameterServiceRequestHandlerExt4.h, ParameterServiceResponseHandlerExt3.h, Error.h
		//! \exception smf::Error	See ParameterServiceRequestHandlerExt4.h for a list of specific exceptions.
		//! \note					The DynamicReloadPartition function is thread safe
		virtual void DynamicReloadPartition(const std::string& newPartitionPath, UnsignedInt identifier) = 0;


		virtual ~ParameterServiceRequestHandlerExt4() {}
