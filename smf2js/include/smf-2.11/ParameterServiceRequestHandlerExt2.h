...
#ifndef PSDSERVICERREQUESTHANDLEREXT2_H
#define PSDSERVICERREQUESTHANDLEREXT2_H


#include "ParameterServiceRequestHandlerExt1.h"

//! Psd Service - Support transactional or non-transactional query
//! This interface is for the remote client to make requests for Values, Handles or updates
//! 

namespace smf{
	class ParameterServiceRequestHandlerExt2 : public ParameterServiceRequestHandlerExt1
	{
	public:
		...
		virtual ~ParameterServiceRequestHandlerExt2() {}
