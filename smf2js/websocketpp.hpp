...
namespace smf2js
{
	...
	public:
		...
		void on_open(client * c, websocketpp::connection_hdl hdl) {
			...
			//Sleep(200);
			WsIncomingQueue.enqueue("ws-connected");
		...
		void on_close(client * c, websocketpp::connection_hdl hdl) {
			...
			// TODO: raise event if con->get_remote_close_code() == 1006 to have thread try to reconnect
			if (con->get_remote_close_code() == 1006)
				m_status += "_1006";
		}
		...
		void on_message(websocketpp::connection_hdl, client::message_ptr msg) {
			if (msg->get_opcode() == websocketpp::frame::opcode::text) {
				...
				WsIncomingQueue.enqueue(msg->get_payload());
			}
			else {
